...
class ContrastModel(BertPreTrainedModel):
    def __init__(self, config, cls_loss=True, contrast_loss=True, graph=False, layer=1, data_path=None,
                 multi_label=False, lamb=1, threshold=0.01, tau=1, plm_name='bert-base-uncased'):
        ...
        self.graph_encoder = GraphEncoder(
            config, graph, layer=layer, data_path=data_path, threshold=threshold, tau=tau, plm_name=plm_name
        )
        self.lamb = lamb
